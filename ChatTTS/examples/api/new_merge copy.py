...
def merge_audio_files(base_dir, jsonl_dir, output_dir, max_workers=None):
    """多线程版本的合并音频文件函数"""
    # 获取所有tts目录
    tts_dirs = glob.glob(os.path.join(base_dir, "tts*"))
...
if __name__ == "__main__":
    ...
    base_directory = "/root/code/ChatTTS/output/POS-multi-agent_FINAL_project-9_20250303_145753"
    # 设置JSONL文件所在的目录
    jsonl_directory = "/root/code/antifraud/AntiFraudMatrix-normal/results/normal-full_dialogues_20250303_015751"  # 请替换为实际的JSONL文件目录
    # 设置输出目录
    output_directory = "/root/code/ChatTTS/merged_result/testPOS-multi-agent-8"  # 请替换为实际的输出目录
